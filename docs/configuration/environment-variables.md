...
| `TLS_CERT`                            | `-`                                                                                                     | no                    | Base64-encoded TLS certificate. When set along with `TLS_KEY`, the server enables HTTPS.                                                                                                                                                                                                                                                                                  |
| `TLS_KEY`                             | `-`                                                                                                     | no                    | Base64-encoded TLS private key. When set along with `TLS_CERT`, the server enables HTTPS. The server monitors the certificate and key files and will automatically reload them when they change.                                                                                                                                                                          |
